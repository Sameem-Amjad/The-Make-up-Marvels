...
const UpdateProduct = () =>
{
    ...
    {
        let result = await fetch( 'http://localhost:4000/admin/update-product', {
            method: 'POST',
        ...
        if ( result )
        {
            productName !== "" ? navigate( '/admin/update-product' ) : navigate( '/admin' );
        }
    }
    return (
        <>
            <form id="true" className="flex w-full  bg-slate-700 justify-center ">
                <div className="flex w-1/2  justify-center ">
                    <div className="flex flex-col text-white w-10/12 shadow-2xl shadow-white items-center gap-5 m-4 rounded-xl bg-gray-800 ">
                        ...
                        <div className="flex flex-col w-11/12 gap-2">
                            <label htmlFor="updateName" className="text-violet-79">New Product Name</label>
                            <input onChange={ ( e ) =>
                            {
                                setUpdateName( e.target.value );
                            } } id="updateName" type="text" className="border-violet-700 shadow-lg shadow-violet-700/50  rounded-lg w-full p-2.5 bg-gray-700 placeholder-gray-400 text-white focus:border-none focus:ring-4  focus:ring-violet-700" placeholder="..." />
                        </div>
                        <div className="flex flex-col w-11/12 gap-2">
