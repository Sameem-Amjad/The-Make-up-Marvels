...
const AddProduct = () =>    
{
    ...
    {
        let result = await fetch( 'http://ec2-16-16-202-180.eu-north-1.compute.amazonaws.com:4000/admin/add-product', {
            method: 'POST',
        ...
        {
            console.log( result );
            productName !== "" ? navigate( '/admin/add-product' ) : navigate( '/admin' );
        }
    }
    return (
        <>
                ...
                <div className="flex w-1/2  justify-center ">
                    <div className="flex flex-col text-white w-10/12 shadow-2xl shadow-white items-center gap-5 m-4 rounded-xl bg-gray-800 ">
                        ...
                        <div className="flex flex-col w-11/12 gap-2">
                            <h1 className="text-2xl text-slate-200 font-bold">Add An Product</h1>
                        </div>
                        <div className="flex flex-col w-11/12 gap-2">
